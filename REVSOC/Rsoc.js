...
export default class Rsoc extends Component {
  render() {
    return (
      <View>
        <AppHeader />
      <View style={styles.container}>
        ...
        <Text> </Text>
        <Text style={styles.points}>1)What are the spheres of the Earth?</Text>
        <Text> </Text>
        <TouchableOpacity
              style={styles.buttons}
              onPress={() => this.props.navigation.navigate('Rasoc')}>
